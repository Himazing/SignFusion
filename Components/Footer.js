                ...
                <div className="container text-md-left mt-5">
                    <div className="row mt-3">
                        ...
                        <div className="col-md-4 col-lg-4 col-xl-4 mx-auto mb-4">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: '60px' }} />
                            <p>Nitish Kumar - Co-Founder </p>
                            <p>Himanshu Kumar - Tech Lead</p>
                            <p>Harsh Gupta - AI Specialist</p>
                            <p>Jyoti Mishra - Frontend Developer</p>
                        </div>
                        ...
                        <div className="col-md-4 col-lg-4 col-xl-4 mx-auto mb-md-0 mb-4">
                            ...
                            <p><i className="fa fa-phone me-3 ms-0"></i> +91 7903658301</p>
                        </div>
                    </div>
                </div>
